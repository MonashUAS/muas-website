...
export const navButtonClass =
  "flex h-10 w-[84px] items-center justify-center rounded-full bg-white/[0.12] text-[0.65rem] uppercase tracking-[0.14em] text-white/88 transition-colors duration-300 hover:bg-white/[0.18] hover:text-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/40 sm:h-11 sm:w-[132px] sm:text-b2 sm:tracking-[0.18em] motion-reduce:transition-none cursor-pointer";
