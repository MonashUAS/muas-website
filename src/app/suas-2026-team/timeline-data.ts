...
export const timelineItems: TimelineItemContent[] = [
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/Diversion Sim Verification.webp`,
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/Physical Avoidance and Diversion Test.webp`,
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/First Braking System Drop Simulation.webp`,
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/First Successful Propulsion Test.webp`,
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/Vision Detection and Payload Deployment.webp`,
  ...
  timelineItem({
    ...
    image: `${timelineImageDir}/First Lifeline Deployment.webp`,
